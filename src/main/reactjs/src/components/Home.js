                ...
                <div id={'#page-container'}>
                    <div className={'container'}>
                        ...
                        <div className={'row'} id={'row1'}>
                            <div className={'col-lg-4 cardBorder'}>
                                <a>
                                ...
                                <div className="card-body">
                                    <h5 className="card-title">The Library</h5>
                                    <p className="card-text">Join other students in their studying sessions! In the library you can find many likeminded people striving for growth and success.</p>
                                </div>
                                </a>
                            </div>
                            <div className={'col-lg-4 cardBorder'}>
                                <a>
                                    ...
                                    <div className="card-body">
                                        ...
                                        <p className="card-text">Connect with other students and discuss your problems! Together you can solve everything!</p>
                                    </div>
                                </a>
                            </div>
                            <div className={'col-lg-4 cardBorder'}>
                    ...
                    <div className={'container px-4 py-5'} id={'about'} >
                        <div className={'row'}>
                            <div className={'col-8'}>
                                <h2>About Us</h2>
                                <p >Hello, we are Team BigBrainTime. we are a team of 3 students from TVZ. We are currently in our second year of university.</p>
                                ...
                                <p >For our project we combined Spring and ReactJS.r
                                The Spring Framework is an application framework and inversion of control container for the Java platform. It was used to build the backend of the app.</p>
                            </div>
                            <div className={'col-4'}>
